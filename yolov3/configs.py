...
YOLO_CUSTOM_WEIGHTS         = True #f'checkpoints/yolov4-trt-INT8–416x' # "checkpoints/yolov3_custom" # used in evaluate_mAP.py and custom model detection, if not using leave False
